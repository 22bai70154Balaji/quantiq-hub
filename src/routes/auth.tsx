      ...
      <motion.div initial={{ y: 20, opacity: 0 }} animate={{ y: 0, opacity: 1 }} className="w-full max-w-md">
        ...
        <div className="rounded-3xl border bg-card/80 p-8 shadow-elegant backdrop-blur-xl">
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            {mode === "signin" ? "Sign in to access your dashboard." : "Save calculations, favorites, and AI chats."}
          </p>

          <Button onClick={google} variant="outline" className="mt-6 w-full rounded-xl" disabled={loading}>
